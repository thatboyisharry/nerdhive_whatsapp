...
//       console.log(user)
//        return askUserName()
//       if((!user.isOnboarding)&&((user.name===null|user.name===" "))){
//         console.log("No name user first contact");
  
        
//           responses=await askUserName();
//           responses.to=user.phone;
//           console.log("ask user name")
//           console.log(responses)
//           let onboarding=  await isOnboarding(user);
//           if(onboarding){
//             return responses;
//           }
        
          
//       }else if(user.isOnboarding&&(user.name===null|user.name===" ")){
//       console.log("No name user onboarding");
...
//       }else if(user.isOnboarding&&(!(user.name===null|user.name===" "))){
//         console.log("User with name onboarding");
